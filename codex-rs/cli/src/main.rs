...
fn profile_v2_for_subcommand<'a>(
    ...
    match subcommand {
        ...
        _ => anyhow::bail!(
            "--profile only applies to runtime commands and `kodex mcp`: `kodex`, `kodex exec`, `kodex review`, `kodex resume`, `kodex fork`, `kodex mcp`, `kodex sandbox`, and `kodex debug prompt-input`."
        ),
    }
}
